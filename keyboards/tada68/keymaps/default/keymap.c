...
[_FL] = LAYOUT_ansi(
  ...
  _______,KC_BTN3,_______,BL_DEC, BL_TOGG,BL_INC, _______, _______, _______, _______, _______,     _______, KC_PGUP,KC_VOLD, \
  _______,_______,_______,				KC_MUTE           , _______,_______,_______,KC_HOME,KC_PGDN,KC_END),
};
